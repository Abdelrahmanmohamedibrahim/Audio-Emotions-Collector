    ...
    .then(stream => {
      ...
      mediaRecorder.addEventListener("stop", () => {
        ...
        if (selectedRow[0].className == "happy"){
          ...
          var audioUrl = URL.createObjectURL(happyBlob);
          const audio = new Audio(audioUrl);
        }
...
formData.append('neutral_records', neutralBlob);

formData.append('angry_records', angryBlob);
formData.append('sad_records', sadBlob);
formData.append('fear_records', fearBlob);
formData.append('happy_records', happyBlob);
